...
export const TradingCalendar: React.FC<TradingCalendarProps> = ({ data }) => {
  ...
  const renderHeaderAction = (
    <div className="flex items-center gap-2">
        {/* Navigation Controls (Only show if expanded) */}
        {isExpanded && (
        ...
        <button 
            ...
            title={isExpanded ? "Colapsar calendario" : "Desplegar calendario"}
        >
  ...
  return (
    <Card title="Calendario de Rendimiento" action={renderHeaderAction}>
      {isExpanded ? (
          <div className="w-full overflow-x-auto animate-in fade-in slide-in-from-top-4 duration-300">
