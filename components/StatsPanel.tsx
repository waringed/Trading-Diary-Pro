...
export const StatsPanel: React.FC<StatsPanelProps> = ({ stats }) => {
  ...
  return (
    <Card title="Análisis Detallado" action={renderAction}>
        {/* Collapsible Content */}
        {isExpanded ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 animate-in fade-in slide-in-from-top-4 duration-300">
