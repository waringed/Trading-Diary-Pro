...
export const HistoryTable: React.FC<HistoryTableProps> = ({ 
  ...
  return (
    <div className="bg-slate-800 border border-slate-700 rounded-xl shadow-lg overflow-hidden flex flex-col min-h-0">
      ...
      <div className="px-6 py-4 border-b border-slate-700 bg-slate-800/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
              {/* View Mode Tabs (Only if expanded) */}
              {isExpanded && (
              ...
              <button 
                ...
                className="text-slate-400 hover:text-white transition-colors bg-slate-900 p-2 rounded-lg border border-slate-700 h-full flex items-center"
                title={isExpanded ? "Colapsar tabla" : "Desplegar tabla"}
              >
